...
From this study, we can conclude that the effect of operating system libraries on the output images from HCP Preprocessing pipelines is significant. HCP preprocessing pipeline results are influenced by the operating systems on which the processing takes place. Also the differences in these images are visually substantial.
