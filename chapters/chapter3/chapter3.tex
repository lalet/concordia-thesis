...
images are exactly similiar and 0 meaning there is zero similarity. The 
equation used for finding the Dice coefficient is given in 
\ref{eq:eq_two}. Consider $|I1|\&|I2|$, as the absolute voxel intensity 
values of the images \todo{this is wrong}. We computed the voxelwise 
