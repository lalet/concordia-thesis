...
equation~\ref{eq:eq_two}. $|I1|$ and $|I2|$, are the total number of voxels in the images I1 and I2, and $|I1 - I2|$ computes the non-zero voxel differences. We computed the voxel 
