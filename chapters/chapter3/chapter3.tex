...
\begin{center}
   \includegraphics[width=\linewidth]{hcp_pipeline_overview}
   \captionof{figure}{HCP Pipelines Overview}
   \label{fig:hcp_pipelines_overview}
 \end{center}

Out of the six pipelines six pipelines mentioned in the above paragraph, we used three structural pipelines and one functional pipeline for study. They pipelines are listed below, 
\begin{itemize}
  \item PreFreeSurfer
  \item Freesurfer
  \item PostFreeSurfer
