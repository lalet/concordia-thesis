...
\Pn{\FDice{$image\-1$,$image\-2$}}{
  \begin{algorithmic}
    ...
    \STATE \textbf{Dice\_coeff} $\leftarrow$ (((nonzero\_voxels\_image1+nonzero\_voxels\_image2)-nonzero\_voxels\_difference)/(nonzero\_voxels\_image1+nonzero\_voxels\_image2));
  \end{algorithmic}
\KwRet \textbf{Dice\_coeff}\;
}
\caption*{Algorithm for finding Dice coefficient similarity from images}
