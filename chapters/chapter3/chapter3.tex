...
\begin{algorithmic}[1]
    \Function{Euclid1}{$image_1, image_2b$}\Comment{The g.c.d. of a and b}
    ...
    \EndFunction
    \Statex
    \Function{Convert}{$image_1, image_2$}\Comment{Images to be converted}
    \if{$extension is .mgz$} 
      \State {$convert image to .nii.gz$}
    \else 
      \State {$Do nothing$} 
    \endif
    \State \textbf{return} $b$\Comment{The gcd is b}
