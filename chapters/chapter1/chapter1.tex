...
With the rapid changes happening in the computational softwares and infrastructure, several external factors like the version of libraries, hardware architecture plays an important role in the reproducibilityi \cite{10.1371/journal.pone.0038234,Gla15}. Peng defined a reproducibility standard, and emphasized on the importance on sharing of code and data among the scientific community \cite{Peng2011}.
