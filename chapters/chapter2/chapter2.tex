...
%Amazon S3
``Amazon S3 is object storage built to store and retrieve any amount of data from anywhere on the web" \cite{Amazon-Web-Services}. S3 storage durable, scalable and secure. The downloading of data incurs a charge, but transferring data to S3 is free. S3 is thus suitable for less frequently accessed data.
