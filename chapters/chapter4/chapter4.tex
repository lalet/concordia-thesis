...
\begin{tabu} to \textwidth { | X[l] | X[l] | }
  ...
  \hline
\end{tabu}
\captionof{table}{HCP Subject Size before preprocessing}
...
Figures \ref{fig:prefreesurfer_run} and \ref{fig:prefreesurfer_file_size} shows the details about processing time and file-size on CentOS6 and CentOS7 respectively.
...
\captionof{figure}{PreFreeSurfer processing time on (i) CentOS6 (left) (ii)CentOS7 (right)}
...
\captionof{figure}{PreFreeSurfer processing file-size on (i) CentOS6 (left) (ii) CentOS7 (right)}
\label{fig:prefreesurfer_file_size}
\end{center}

\subsection{FreeSurfer}
Figures \ref{fig:freesurfer_run} and \ref{fig:freesurfer_file_size} shows the details about processing time and file-size on CentOS6 and CentOS7 respectively.
...
\captionof{figure}{FreeSurfer processing time on (i) CentOS6 (left) (ii)CentOS7 (right)}
...
\captionof{figure}{FreeSurfer processing file-size on (i) CentOS6 (left) (ii) CentOS7 (right)}
\label{fig:freesurfer_file_size}
\end{center}

\subsection{PostFreeSurfer}
Figures \ref{fig:postfreesurfer_run} and \ref{fig:postfreesurfer_file_size} shows the details about processing time and file-size on CentOS6 and CentOS7 respectively.
...
\captionof{figure}{PostFreeSurfer processing time on (i) CentOS6 (left) (ii)CentOS7 (right)}
...
\captionof{figure}{PostFreeSurfer processing file-size on (i) CentOS6 (left) (ii) CentOS7 (right)}
\label{fig:postfreesurfer_file_size}
\end{center}

\subsection{fMRIVolume}
Figures \ref{fig:fmri_run} and \ref{fig:fmri_file_size} shows the details about processing time and file-size on CentOS6 and CentOS7 respectively.
...
\captionof{figure}{fMRIVolume processing time on (i) CentOS6 (left) (ii)CentOS7 (right)}
\label{fig:fmri_run}
\end{center}
...
\captionof{figure}{fMRIVolume processing file-size on (i) CentOS6 (left) (ii) CentOS7 (right)}
...
Docker container creation was automated with the help of GitHub and DockerHub. All the containers that are used for this study is aviable in the Dockerhub\footnote{\url{https://hub.docker.com/r/bigdatalabteam/hcp-prefreesurfer/tags/}}.

\begin{center}
  \includegraphics[width=\linewidth]{automated_build}
  \caption{Docker automated build}
