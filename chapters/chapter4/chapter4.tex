...
Another task carried out by the PostFreeSurfer pipeline is to combine the structural transforms for T1w and T2w images from the PreFreeSurfer and FreeSurfer pipelines. This transformed file is then applied to the averaged T1w and T2w images and they are brought to the native volume and MNI spaces. 
