...
recon-all processing resumes. \todo{is the previous paragraph yours?}
...
in intensity from gray matter in the T2w image. \todo{is the previous paragraph yours?}
...
PostFreeSurfer. \todo{you could make the figure smaller, to have the same size as the other ones.}
