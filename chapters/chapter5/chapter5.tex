...
Figure~\ref{fig:prefreesurfer_raw_file} illustrates the zoomed version of portion of checkerboard image marked with a red square containing differences in Figure~\ref{fig:prefreesurfer_std_file}.
...
\makecell[l]{Std.\\Dev} & 0.073     & 0.377           & 0.009         & 0.3898   & 0.010       & 0.385 \\ \hline
\end{tabularx}
