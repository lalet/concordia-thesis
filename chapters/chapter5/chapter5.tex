...
\captionof{figure}{PreFreeSurfer T2w ACPC file (Checkerboard indicates the differences).\href{https://drive.google.com/file/d/1NrNl7POyCS_SZm3an00wOLUnkmLJ_ngo/view?usp=sharing}{Link}}
...
\captionof{figure}{FreeSurfer Aseg hires file (Bright spots in the images shows the differences). \href{https://drive.google.com/file/d/1WUwWp5muXvotbMQqTqR5LcMyncH1ET3P/view?usp=sharing}{Link}}
