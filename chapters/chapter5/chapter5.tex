...
\hfill \break
\begin{center}
\includegraphics[width=.5\linewidth]{T1w_bin_differences.png}%
\includegraphics[width=.5\linewidth]{T1w_bin_differences2.png}
\captionof{figure}{PreFreeSurfer T1wmulT2w brain normalization file (Thick Blue shaded region shows the binarized differences).}
...
\hfill \break
\begin{center}
\includegraphics[width=.5\linewidth]{T2w_acpc_prefreesurfer1.png}%
\includegraphics[width=.5\linewidth]{T2w_acpc_prefreesurfer3.png}
\captionof{figure}{PreFreeSurfer T2w ACPC file (Blue shaded region shows the differences).}
...
\hfill \break
\begin{center}
\includegraphics[width=.5\linewidth]{str1.png}%
\includegraphics[width=.5\linewidth]{str2.png}
\captionof{figure}{Illustrates the differences in the standard2std file}
...
\captionof{figure}{FreeSurfer Aseg hires file (Yellow shaded region shows the differences in the image in between two conditions)}
...
\captionof{figure}{All Grey Matter file with differences (Blue shaded region shows the CentOS 6 output and yellow region shows the CentOS 7 output).}
...
\hfill \break
\begin{center}
\includegraphics[width=.5\linewidth]{scout_gdc_view.png}%
\includegraphics[width=.5\linewidth]{scout_gdc_view1.png}
\captionof{figure}{Differences in the Scout\_gdc\_undistorted2T1w file}
