...
\begin{center}
\includegraphics[width=.9\linewidth]{t1wmul_checkerboard_patchsize5.png}
  \captionof{figure}{PreFreeSurfer T1wmulT2w brain normalization file (Small squares in the image indicates the differences). \href{https://drive.google.com/file/d/1eHyrs180QbF4a-kSSz5mFkdirTgdXhc_/view?usp=sharing}{Link}}
...
\begin{center}
\includegraphics[width=\linewidth]{t2w_acpc_patchsize_5.png}
\captionof{figure}{PreFreeSurfer T2w ACPC file (Small squares in the figure indicates the differences).\href{https://drive.google.com/file/d/1NrNl7POyCS_SZm3an00wOLUnkmLJ_ngo/view?usp=sharing}{Link}}
...
\begin{center}
\includegraphics[width=\linewidth]{raw_bias_patchsize5.png}
  \captionof{figure}{Illustrates the differences in the bias raw file (Small squares in the figure indicates the differences). \href{https://drive.google.com/file/d/1rbGR0zGPQsOPzEVkiR6NynudbfjDFLvn/view?usp=sharing}{Link}}
...
\captionof{figure}{Differences in the ribbon file from FreeSurfer Result (Bright spots in the figure shows the differences). \href{https://drive.google.com/file/d/14nQNb9qNxqgpUrl4D1P6BYplXsGpNUx_/view?usp=sharing}{Link}}
...
\captionof{figure}{FreeSurfer Aseg hires file (Bright spots in the figure shows the differences). \href{https://drive.google.com/file/d/1WUwWp5muXvotbMQqTqR5LcMyncH1ET3P/view?usp=sharing}{Link}}
...
\captionof{figure}{Illustrates the differences in aparc.a2009s+aseg file. \href{https://drive.google.com/file/d/1eeofWaPyk-A2pQd6LlieQwbMYVOrfeI3/view?usp=sharing}{Link}}
...
\begin{center}
\includegraphics[width=\linewidth]{scout_patchsize2-1.png}%
